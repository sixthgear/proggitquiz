...
urlpatterns = patterns('pq.views',
    ...
    (r'^challenge/(?P<problem>\d+)/s-(?P<solution>\d+)/$',          'solution'),
    (r'^challenge/(?P<problem>\d+)/s-(?P<solution>\d+)/raw/$',      'solution_raw'),
    (r'^challenge/(?P<problem>\d+)/s-(?P<solution>\d+)/download/$', 'solution_download'),
